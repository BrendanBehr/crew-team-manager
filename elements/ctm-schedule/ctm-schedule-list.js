    ...
    render() {
        ...
        <app-header-layout id="layout" has-scrolling-region fullbleed>
            ...
            <iron-pages id="pages" attr-for-selected="id" selected="[[page]]">
                ...
                <ctm-schedule-list-results id="results" data="[[_data]]" selected="[[selected]]" on-ctm-schedule-list-results-action-delete-multiple="_prepareDelete"></ctm-schedule-list-results>
