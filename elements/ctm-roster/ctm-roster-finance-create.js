...
export class CtmRosterFinanceCreate extends LitElement {
    static styles = css`
        :host {
    ...
    _handleActionCancel(e) {
        this.dispatchEvent(new CustomEvent('ctm-roster-finance-create-action-cancel', {
            bubbles: true,
            composed: true
        }));
        this._resetCreate();
        ...
        this.$.firebase.saveValue('finances')
            .then(() => {
                ...
                this.$.firebase.setStoredValue(path, true)
                    .then(() => {
                        this.dispatchEvent(new CustomEvent('ctm-roster-finance-create-action-created', {
                                detail: {
                                    finance: gross
                                },
                                bubbles: true,
                    ...
                    .catch(() => {
                        ...
                        this.dispatchEvent(new CustomEvent('ctm-roster-finance-create-action-fanout-fail', {
                                bubbles: true,
                                composed: true
                            }));
                    });
...
customElements.define('ctm-roster-finance-create', CtmRosterFinanceCreate);