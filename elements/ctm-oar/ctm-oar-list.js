    ...
    render() {
        ...
        <app-header-layout id="layout" has-scrolling-region fullbleed>
            ...
            <iron-pages id="pages" attr-for-selected="id" selected="${this.page}">
                ...
                <ctm-oar-list-results id="results" data="${this._data}" selected="${this.selected}" on-ctm-oar-list-results-action-delete-multiple="_prepareDelete"></ctm-oar-list-results>
