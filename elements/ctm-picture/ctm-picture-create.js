...
export class CtmPictureCreate extends LitElement {
    ...
    _handleActionCancel() {
        this.dispatchEvent(new CustomEvent('ctm-picture-create-action-cancel', {
            bubbles: true,
            composed: true
        }));
        this._resetCreate();
    ...
    _handleActionCreate(e) {
        ...
        this.$.firebase.saveValue('pictures')
            .then(() => {
                ...
                this.dispatchEvent(new CustomEvent('ctm-picture-create-action-created', {
                        detail: {
                            picture: _key
                        },
                        bubbles: true,
...
customElements.define('ctm-picture-create', CtmPictureCreate);