...
import './ctm-fleet-list-loading';
import './ctm-fleet-list-results';
import './ctm-fleet-list-message';

export class CtmFleetList extends LitElement {
    static styles = css`
        :host {
        ...
        <app-header-layout id="layout" has-scrolling-region fullbleed>
            ...
            <app-header slot="header" reveals>
                <app-toolbar id="toolbar">
                    ...
                    <div main-title id="title">Boats</div>
            ...
            <iron-pages id="pages" attr-for-selected="id" selected="${this.page}">
                <ctm-fleet-list-loading id="loading"></ctm-fleet-list-loading>
                <ctm-fleet-list-results id="results" data="${this._data}" selected="${this.selected}" on-ctm-fleet-list-results-action-delete-multiple="_prepareDelete"></ctm-fleet-list-results>
                <ctm-fleet-list-message id="message"></ctm-fleet-list-message>
            </iron-pages>
    ...
    _handleActionMenu() {
        this.dispatchEvent(new CustomEvent('ctm-fleet-list-action-menu', {
            bubbles: true,
            composed: true
        }));
    }
    ...
    _handleActionLogout() {
        this.dispatchEvent(new CustomEvent('ctm-fleet-list-action-logout', {
            bubbles: true,
            composed: true
        }));
    }
    ...
    _handleActionCreate() {
        this.dispatchEvent(new CustomEvent('ctm-fleet-list-action-create', {
            bubbles: true,
            composed: true
        }));
    }
    ...
    _prepareDelete(e) {
        this.reveal = true;
        this.selected = true;
        this._deleteItems.push(e.detail.fleet)
    }
...
customElements.define('ctm-fleet-list', CtmFleetList);