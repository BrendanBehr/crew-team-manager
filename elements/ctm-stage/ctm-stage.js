...
export class CtmStage extends LitElement {
    ...
    <iron-pages id="pages" attr-for-selected="id" selected="${this.page}">
        <ctm-roster id="roster" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-roster-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-roster>
        <ctm-fleet id="fleet" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-fleet-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-fleet>
        <ctm-schedule id="schedule" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-schedule-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-schedule>
        <ctm-erg id="erg" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout" on-ctm-erg-list-action-menu="_toggleDrawer"
            wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-erg>
        <ctm-finance id="finance" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-finance-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-finance>
        <ctm-oar id="oar" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout" on-ctm-oar-list-action-menu="_toggleDrawer"
            wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-oar>
        <ctm-race id="race" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-race-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-race>
        <ctm-rigger id="rigger" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-rigger-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-rigger>
        <ctm-picture id="picture" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-picture-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-picture>
        <ctm-team id="team" class="page" page="detail" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-team-detail-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-team>
        <ctm-compare id="compare" class="page" page="list" on-ctm-stage-action-logout="_handleActionLogout"
            on-ctm-compare-list-action-menu="_toggleDrawer" wide-layout="${this._wideLayout}" team-id="${this.teamId}"></ctm-compare>
    </iron-pages>

    <app-drawer id="drawer" slot="drawer" opened="${this._wideLayout}" persistent="${this._wideLayout}">
        <paper-listbox>
            <paper-icon-item page="compare" @click="${this._handleMenuClick}">
                <iron-icon page="compare" icon="supervisor-account"></iron-icon>
                Compare
            </paper-icon-item>
            <paper-icon-item page="erg" @click="${this._handleMenuClick}">
                <iron-icon page="erg" icon="places:fitness-center"></iron-icon>
                Erg
            </paper-icon-item>
            <paper-icon-item page="finance" @click="${this._handleMenuClick}">
                <iron-icon page="finance" icon="editor:attach-money"></iron-icon>
                Finance
            </paper-icon-item>
            <paper-icon-item page="fleet" @click="${this._handleMenuClick}">
                <iron-icon page="fleet" icon="maps:directions-boat"></iron-icon>
                Fleet
            </paper-icon-item>
            <paper-icon-item page="oar" @click="${this._handleMenuClick}">
                <iron-icon page="oar" icon="av:shuffle" @click="${this._handleMenuClick}"></iron-icon>
                Oar
            </paper-icon-item>
            <paper-icon-item page="picture" @click="${this._handleMenuClick}">
                <iron-icon page="picture" icon="image:camera-roll"></iron-icon>
                Picture
            </paper-icon-item>
            <paper-icon-item page="race" @click="${this._handleMenuClick}">
                <iron-icon page="race" icon="gavel"></iron-icon>
                Race
            </paper-icon-item>
            <paper-icon-item page="rigger" @click="${this._handleMenuClick}">
                <iron-icon page="rigger" icon="build"></iron-icon>
                Rigger
            </paper-icon-item>
            <paper-icon-item page="roster" @click="${this._handleMenuClick}">
                <iron-icon page="roster" icon="rowing"></iron-icon>
                Roster
            </paper-icon-item>
            <paper-icon-item page="schedule" @click="${this._handleMenuClick}">
                <iron-icon page="schedule" icon="assignment"></iron-icon>
                Schedule
            </paper-icon-item>
            <paper-icon-item page="team" @click="${this._handleMenuClick}">
