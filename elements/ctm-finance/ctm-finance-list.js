...
import './ctm-finance-list-loading';
import './ctm-finance-list-results';
...
export class CtmFinanceList extends LitElement {
    ...
    _handleActionMenu() {
        this.dispatchEvent(new CustomEvent('ctm-finance-list-action-menu', {
            bubbles: true,
            composed: true
        }));
    }
    ...
    _handleActionLogout() {
        this.dispatchEvent(new CustomEvent('ctm-finance-list-action-logout', {
            bubbles: true,
            composed: true
        }));
    }
    ...
    _handleActionCreate() {
        this.dispatchEvent(new CustomEvent('ctm-finance-list-action-create', {
            bubbles: true,
            composed: true
        }));
    }
    ...
    _prepareDelete(e) {
        this.reveal = true;
        this.selected = true;
        this._deleteItems.push(e.detail.finance)
    }
...
customElements.define('ctm-finance-list', CtmFinanceList);